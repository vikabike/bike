...
<?php } ?>
	<div id="social-wrap">
		<div id="social-bar">
			...
			<?php endif; ?>	
			<?php if($modality_theme_options['youtube_link']): ?>
				<a href="<?php echo esc_url($modality_theme_options['youtube_link']); ?>" target="_blank" title="<?php _e('YouTube','modality'); ?>"><i class="fa fa-youtube"></i></a>
			<?php endif; ?>			
		</div>
	</div>
</div>