			...
			<?php if ($modality_theme_options['feature_one_image'] !='') { ?>
				<?php if ($modality_theme_options['feature_one_url'] !='') { ?>
					<a href="<?php echo esc_url($modality_theme_options['feature_one_url']); ?>">
						<div class="circle">
							<img alt="<?php echo esc_attr(_e('Featured Image','modality')); ?>" src="<?php echo esc_url($modality_theme_options['feature_one_image']) ?>">
						</div><!--circle-->
					</a>
				<?php } else { ?>
					<div class="circle">
			...
			<?php if ($modality_theme_options['feature_two_image'] !='') { ?>
				<?php if ($modality_theme_options['feature_two_url'] !='') { ?>
					<a href="<?php echo esc_url($modality_theme_options['feature_two_url']); ?>">
						<div class="circle">
							<img alt="<?php echo esc_attr(_e('Featured Image','modality')); ?>" src="<?php echo esc_url($modality_theme_options['feature_two_image']) ?>">
						</div><!--circle-->
					</a>
				<?php } else { ?>
					<div class="circle">
			...
			<?php if ($modality_theme_options['feature_three_image'] !='') { ?>
				<?php if ($modality_theme_options['feature_three_url'] !='') { ?>
					<a href="<?php echo esc_url($modality_theme_options['feature_three_url']); ?>">
						<div class="circle">
							<img alt="<?php echo esc_attr(_e('Featured Image','modality')); ?>" src="<?php echo esc_url($modality_theme_options['feature_three_image']) ?>">
						</div><!--circle-->
					</a>
				<?php } else { ?>
					<div class="circle">
			...
			<?php if ($modality_theme_options['feature_four_image'] !='') { ?>
				<?php if ($modality_theme_options['feature_four_url'] !='') { ?>
					<a href="<?php echo esc_url($modality_theme_options['feature_four_url']); ?>">
						<div class="circle">
							<img alt="<?php echo esc_attr(_e('Featured Image','modality')); ?>" src="<?php echo esc_url($modality_theme_options['feature_four_image']) ?>">
						</div><!--circle-->
					</a>
				<?php } else { ?>
					<div class="circle">
