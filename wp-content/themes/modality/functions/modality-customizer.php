...
function modality_customize_register($wp_customize){
	...
	class Modality_WP_Customize_Textarea_Control extends WP_Customize_Control {
	...
	class Modality_WP_Customize_Info_Control extends WP_Customize_Control {
		public $type = 'info';
	
		public function render_content() {
			?>
				<strong> <?php _e('If you like our work. Buy us a coffee.','modality'); ?></strong>
                <div class="donate">
				...
				<p class="btn">
					<a class="button button-primary" target="_blank" href="http://www.vmthemes.com/faq/"><?php _e('Theme Support','modality') ?></a><br><br>
					<a class="button button-primary" target="_blank" href="http://www.vmthemes.com/preview/modality/"><?php _e('View Theme Demo','modality') ?></a><br><br>
					<a class="button button-primary" target="_blank" href="http://www.vmthemes.com/modality-pro-wordpress-theme/"><?php  _e('Upgrade to Pro','modality') ?></a>
				</p>
        	<?php	
		}
	}
	...
	// Google Fonts
	$google_fonts = array(
		__('Open Sans','modality') => __('Open Sans','modality'),
		__('Roboto','modality')	=> __('Roboto','modality'),
	);
    ...
    //  = Theme Info Section        =
    //  =============================					
	$wp_customize->add_section( 'modality_theme_settings', array(
	...
	$wp_customize->add_control( new Modality_WP_Customize_Info_Control($wp_customize, 'theme_info', array(
        'label'    => __(' ', 'modality'),
        'section'  => 'modality_theme_settings',
    ...
    //  = General Section           =
    //  =============================					
	$wp_customize->add_section( 'modality_general_settings', array(
    	'title'          => __( 'General Settings', 'modality' ),
    	'priority'       => 1000,
		'panel' => 'theme_options',
	) );
	//===============================
	...
	$wp_customize->add_control( new WP_Customize_Color_Control($wp_customize, 'theme_color', array(
        ...
        'section'  => 'modality_general_settings',
    ...
    $wp_customize->add_control('responsive_design', array(
        ...
        'label'    => __('Enable Responsive Design', 'modality'),
        'section'  => 'modality_general_settings',
        'type'     => 'checkbox',
    ));
	//===============================
	...
	$wp_customize->add_section( 'modality_logo_settings', array(
    	'title'          => __( 'Logo Settings', 'modality' ),
    	'priority'       => 1001,
		'panel' => 'theme_options',
		'description' => __('To upload custom logo image - go to Appearance > Customize > Site Identity', 'modality'),
	) );
	//===============================    
    ...
    $wp_customize->add_control('logo_width', array(
        ...
        'section'    => 'modality_logo_settings',
	...
	$wp_customize->add_section( 'modality_navigation_settings', array(
    	'title'          => __( 'Navigation Settings', 'modality' ),
    	'priority'       => 1002,
		'panel' => 'theme_options',
	) );
	//===============================
    ...
    $wp_customize->add_control('menu_sticky', array(
        ...
        'section'  => 'modality_navigation_settings',
        'type'     => 'checkbox',
    ));
	//===============================
    ...
    //  = Typography Section        =
    //  =============================
	$wp_customize->add_section( 'modality_typography_settings', array(
    	'title'          => __( 'Typography Settings', 'modality' ),
    	'priority'       => 1003,
		'panel' => 'theme_options',
	) );
	//===============================
    ...
    $wp_customize->add_control( 'google_font_body', array(
        ...
        'section' => 'modality_typography_settings',
        'type'    => 'select',
        'choices'    => $google_fonts,
    ));
	//===============================
    ...
    //  = Header Section            =
    //  =============================
	$wp_customize->add_section( 'modality_header_settings', array(
    	'title'          => __( 'Header Settings', 'modality' ),
    	'priority'       => 1004,
		'panel' => 'theme_options',
	) );
	//===============================
	...
	$wp_customize->add_control( new WP_Customize_Color_Control($wp_customize, 'header_bg_color', array(
        ...
        'section'  => 'modality_header_settings',
    ...
    //  = Home Page Section         =
    //  =============================
	$wp_customize->add_section( 'modality_home_settings', array(
    	'title'          => __( 'Home Page Settings', 'modality' ),
    	'priority'       => 1005,
		'panel' => 'theme_options',
	) );
	//===============================
    ...
    $wp_customize->add_control('image_slider_on', array(
        ...
        'section'  => 'modality_home_settings',
        'type'     => 'checkbox',
    ));
	//===============================
    ...
    //  =============================
	$wp_customize->add_section( 'modality_slider_settings', array(
    	'title'          => __( 'Image Slider Settings', 'modality' ),
    	'priority'       => 1006,
		'panel' => 'theme_options',
	) );
	//===============================
    ...
    $wp_customize->add_control('default_image_slider', array(
        ...
        'section'    => 'modality_slider_settings',
    ...
    //  = Footer Section            =
    //  =============================
	$wp_customize->add_section( 'modality_footer_settings', array(
    	'title'          => __( 'Footer Settings', 'modality' ),
    	'priority'       => 1007,
		'panel' => 'theme_options',
	) );
	//===============================
	...
	$wp_customize->add_control( new WP_Customize_Color_Control($wp_customize, 'footer_bg_color', array(
        ...
        'section'  => 'modality_footer_settings',
    ...
    //  = Layout Section            =
    //  =============================
	$wp_customize->add_section( 'modality_layout_settings', array(
    	'title'          => __( 'Layout Settings', 'modality' ),
    	'priority'       => 1008,
		'panel' => 'theme_options',
	) );
	//===============================
    ...
    $wp_customize->add_control( 'layout_settings', array(
        ...
        'section' => 'modality_layout_settings',
        'type'    => 'radio',
    ...
    //  = Blog Section              =
    //  =============================
	$wp_customize->add_section( 'modality_blog_settings', array(
    	'title'          => __( 'Blog Settings', 'modality' ),
    	'priority'       => 1009,
		'panel' => 'theme_options',
	) );
	//===============================
	...
	$wp_customize->add_control( new WP_Customize_Color_Control($wp_customize, 'blog_posts_home_color', array(
        ...
        'section'  => 'modality_blog_settings',
    ...
    //  = Get Started Section       =
    //  =============================
	$wp_customize->add_section( 'modality_gs_settings', array(
    	'title'          => __( 'Get Started Section', 'modality' ),
    	'priority'       => 1010,
		'panel' => 'theme_options',
	) );
	//===============================
    ...
    //  = Features Settings         =
    //  =============================
	$wp_customize->add_section( 'modality_features_settings', array(
    	'title'          => __( 'Features Section', 'modality' ),
    	'priority'       => 1011,
		'panel' => 'theme_options',
	) );
	//===============================
	...
	$wp_customize->add_control( new WP_Customize_Color_Control($wp_customize, 'features_bg_color', array(
        'label'    => __('Background Color', 'modality'),
        'section'  => 'modality_features_settings',
    ...
    //  = About Us Settings         =
    //  =============================
	$wp_customize->add_section( 'modality_about_settings', array(
    	'title'          => __( 'About Us Section', 'modality' ),
    	'priority'       => 1012,
		'panel' => 'theme_options',
	) );
	//===============================
	...
	$wp_customize->add_control( new WP_Customize_Color_Control($wp_customize, 'about_bg_color', array(
        'label'    => __('Background Color', 'modality'),
        'section'  => 'modality_about_settings',
    ...
    $wp_customize->add_control( new Modality_WP_Customize_Textarea_Control( $wp_customize,'about_section_text', array(
    ...
    //  =============================
	$wp_customize->add_section( 'modality_services_settings', array(
    	'title'          => __( 'Services Section', 'modality' ),
    	'priority'       => 1013,
		'panel' => 'theme_options',
	) );
	//===============================
	...
	$wp_customize->add_control( new WP_Customize_Color_Control($wp_customize, 'services_bg_color', array(
        'label'    => __('Background Color', 'modality'),
        'section'  => 'modality_services_settings',
    ...
    $wp_customize->add_control( new Modality_WP_Customize_Textarea_Control( $wp_customize, 'services_section_desc', array(
        'label'      => __('Description Text', 'modality'),
        'section'    => 'modality_services_settings',
    ...
    //  =============================
	$wp_customize->add_section( 'modality_cta_settings', array(
    	'title'          => __( 'Call To Action Section', 'modality' ),
    	'priority'       => 1014,
		'panel' => 'theme_options',
	) );
	//===============================
    ...
    //  =============================
	$wp_customize->add_section( 'modality_cb_settings', array(
    	'title'          => __( 'Content Boxes Section', 'modality' ),
    	'priority'       => 1015,
		'panel' => 'theme_options',
	) );
	//===============================
    ...
    $wp_customize->add_control(new Modality_WP_Customize_Textarea_Control( $wp_customize, 'first_column_text', array(
    ...
    $wp_customize->add_control(new Modality_WP_Customize_Textarea_Control( $wp_customize, 'second_column_text', array(
    ...
    $wp_customize->add_control(new Modality_WP_Customize_Textarea_Control( $wp_customize, 'third_column_text', array(
    ...
    //  =============================
	$wp_customize->add_section( 'modality_git_settings', array(
    	'title'          => __( 'Get In Touch Section', 'modality' ),
    	'priority'       => 1016,
		'panel' => 'theme_options',
	));
	//===============================
    ...
    //  =============================
	$wp_customize->add_section( 'modality_news_settings', array(
    	'title'          => __( 'Latest News Section', 'modality' ),
    	'priority'       => 1017,
		'panel' => 'theme_options',
	));
	//===============================
	...
	$wp_customize->add_control( new WP_Customize_Color_Control($wp_customize, 'blog_bg_color', array(
        'label'    => __('Background Color', 'modality'),
        'section'  => 'modality_news_settings',
    ...
    //  = Social Settings           =
    //  =============================
	$wp_customize->add_section( 'modality_social_settings', array(
    	'title'          => __( 'Social Links', 'modality' ),
    	'priority'       => 1018,
		'panel' => 'theme_options',
	...
	$wp_customize->add_control( new WP_Customize_Color_Control($wp_customize, 'social_color', array(
        'label'    => __('Background Color', 'modality'),
        'section'  => 'modality_social_settings',
	...
	//===============================
    $wp_customize->add_setting( 'modality_theme_options[youtube_link]', array(
        'default'        => '#',
		'sanitize_callback' => 'esc_url',
        'capability'     => 'edit_theme_options',
        'type'           => 'option',
    ...
    $wp_customize->add_control('youtube_link', array(
        'label'      => __('YouTube', 'modality'),
        'section'    => 'modality_social_settings',
        'settings'   => 'modality_theme_options[youtube_link]',
    ));
...
function modality_theme_custom_styling() {
	...
	*/
	 ...
	 */	
	if ( $slider_height )
	$output .= '.banner ul li { min-height:' . $slider_height . 'px;}' . "\n";
